        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.workspace_premium_rounded, size: 30, color: AppColors.primary),
            ),
            const SizedBox(height: 16),
            const Text('구독이 시작되었어요!', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
