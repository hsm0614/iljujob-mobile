...
class UrgentSentHistoryScreen extends StatefulWidget {
  ...
  @override
  State<UrgentSentHistoryScreen> createState() =>
      _UrgentSentHistoryScreenState();
}
...
class _UrgentSentHistoryScreenState extends State<UrgentSentHistoryScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final uri = Uri.parse(
        '$baseUrl/api/direct-message/sent-history',
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 6),
          Text(
            '긴급호출을 보내면 여기서 응답 현황을 확인할 수 있어요.',
