...
class _ApplicantListScreenState extends State<ApplicantListScreen> {
  ...
  Future<void> _goToChatRoom(int workerId) async {
    ...
    try {
      ...
      final getRes = await AuthenticatedHttpClient.get(getUri);
      if (getRes.statusCode == 200) {
        ...
        final startRes = await AuthenticatedHttpClient.postJson(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final double? aiScore =
                        a['ai_score'] != null
                            ...
                            : null;
                    final List reasons = (a['ai_reasons'] as List?) ?? [];
                    final double? distKm =
                        a['dist_km'] != null
                    ...
                    return _buildApplicantCard(
                      ...
                      completedCount:
                          int.tryParse(
                            (a['completed_count'] ?? '0').toString(),
                          ) ??
                          0,
                      mannerPoint:
                          int.tryParse((a['manner_point'] ?? '0').toString()) ??
                          0,
                    );
                  },
                ),
  ...
  Widget _buildApplicantCard({
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color:
              hasAi && aiScore >= 0.80 ? scoreColor.withOpacity(0.4) : _border,
                ...
                children: [
                  ...
                  if (hasAi) ...[
                    Container(
                      ...
                      height: 24,
                      decoration: BoxDecoration(
                        color: rank <= 3 ? scoreColor.withOpacity(0.15) : _bg,
