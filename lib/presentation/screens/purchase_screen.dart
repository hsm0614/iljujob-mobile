...
class _PurchasePassScreenState extends State<PurchasePassScreen>
  ...
  Future<void> _refreshPassCount() async {
    ...
    if (res.statusCode == 200 && mounted) {
      ...
      setState(() {
        remainingInstant =
            int.tryParse('${data['instant'] ?? data['remaining'] ?? 0}') ?? 0;
    ...
    return Column(
      children: [
                          ...
                          children: [
                            Expanded(
                              child: Wrap(
                                ...
                                children: [
                                  _PriceChip(
                                    label: widget.formatPrice(price),
                                    color: isSelected ? _blue : _text,
                                    bgColor:
                                        isSelected
        ...
        _BottomCta(
          ...
          label: _selected != null ? '구매하기' : '이용권을 선택해주세요',
          onTap:
              _selected == null
                  ? null
                  : () {
